...
let colorArr = [
  ...
  {'name':'red','rgb':'rgb(169,206,102)','rgba':'rgba(169,206,102,0.5)'},
  {'name':'red','rgb':'rgb(110,130,146)','rgba':'rgba(110,130,146,0.5)'},
...
function init(param_data, domEc) {
  ...
  option.legend.itemGap=Math.ceil(($('#pieEc').height()-20*(data.length+2))/data.length);
  option.legend.top=Math.ceil(($('#pieEc').height()-20*(data.length+2))/data.length);
